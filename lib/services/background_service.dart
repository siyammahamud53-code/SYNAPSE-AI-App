...
class BackgroundService extends ChangeNotifier {
  ...
  void _startMonitoring() {
    ...
    // Connectivity monitoring (Fixed List/Single Object issue)
    _connectivity.onConnectivityChanged.listen((results) {
      final isDisconnected = (results is List)
  ...
  Future<Map<String, dynamic>> executeTask(String taskName, Map<String, dynamic> params) async {
    final task = {
      'type': 'automation',
      'name': taskName,
      'parameters': params,
    ...
    await addTask(task);
    return {'status': 'queued', 'taskName': taskName};
  }
